    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex justify-center gap-4">
          <a href="/dashboard" className="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700">Masuk ke Dashboard</a>
          <a href="/graph" className="bg-white text-blue-600 py-2 px-4 rounded-lg border-2 border-blue-600 hover:bg-blue-600 hover:text-white">Analisa Grafik</a>
        </div>
      </div>
    </section>
  );
